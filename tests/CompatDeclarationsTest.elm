module CompatDeclarationsTest exposing (compatTest)

import ErrorUtils
import Expect
import Glsl exposing (Declaration)
...
compatTest : Test
compatTest =
    test "Compat definitions" <| \_ ->
    case Parser.Advanced.run Glsl.Parser.file source of
        Err e ->
            ErrorUtils.errorsToString source e
                |> Expect.fail
